    ...
    public static List<LicenseQuestion> GetAllRegisteredLicenses()
    {
        return new List<LicenseQuestion>()
        {
            ...
            new LicenseQuestion
            {
                ...
                DisplayTextFull =
                    @"Dieser Beitrag steht unter der Lizenz 'Creative Commons: Namensnennung 4.0 International'. Du kannst ihn frei verwenden und verändern, solange du den Autor angibst und die Lizenz verlinkst 
            ...
            new LicenseQuestion
            {
                ...
                DisplayTextFull =
                    "Dieser Beitrag stellt ein 'anderes amtliches Werk' gemäß <a href='https://www.gesetze-im-internet.de/urhg/__5.html' target='_blank'>§ 5 Abs. 2 des Urheberrechtsgesetzes</a> dar. Es darf frei verwendet werden, allerdings unter Angabe der Quelle und ohne Veränderungen.",
            ...
            new LicenseQuestion
            {
                ...
                DisplayTextFull =
                    "Die <a href='https://www.elwis.de/Freizeitschifffahrt/fuehrerscheininformationen/' target='_blank'>Frage und die Antwortmöglichkeiten</a> " +
            ...
            new LicenseQuestion
            {
                ...
                DisplayTextFull =
                    "Die Frage, Antwortmöglichkeiten und die Referenz auf Fundstellen entstammen dem " +
