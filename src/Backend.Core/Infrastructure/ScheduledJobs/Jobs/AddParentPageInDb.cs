...
public class AddParentPageInDb : IJob
{
    ...
    public AddParentPageInDb(PageRepository pageRepository, PageRelationRepo pageRelationRepo, KnowledgeSummaryUpdateService knowledgeSummaryUpdateService)
    {
    ...
    private Task Run(int childPageId, int parentPageId)
    {
        ...
        new ModifyRelationsForPage(_pageRepository, _pageRelationRepo, _knowledgeSummaryUpdateService).AddParentPage(childPage, parentPageId);
