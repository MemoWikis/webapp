        ...
        return ({ node, editor, getPos }) => {
            ...
            $container.addEventListener('click', () => {
                ...
                $container.setAttribute(
                    'style',
                    `position: relative; outline: ${borderStyle}; ${style} cursor: pointer;`
                )
                Array.from({ length: 4 }, (_, index) => {
                    ...
                    $dot.addEventListener('mousedown', (e) => {
                        ...
                        const onMouseMove = (e) => {
                            if (!isResizing || maxWidth === null) return
                            const deltaX =
                                index % 2 === 0
                                    ? -(e.clientX - startX)
                                    : e.clientX - startX
            ...
            document.addEventListener('click', (e) => {
                ...
                if ($target) {
                    const isClickInside =
                        ...
                        $target.style.cssText === defaultIconStyle
                    if (!isClickInside) {
                        const containerStyle = $container.getAttribute('style')
                        const newStyle =
                            containerStyle === null || containerStyle === void 0
                                ? void 0
                                : containerStyle.replace(
                                      `outline: ${borderStyle}`,
                                      ''
                                  )
