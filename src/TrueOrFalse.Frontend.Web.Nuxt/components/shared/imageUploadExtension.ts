  ...
  addCommands() {
    return {
      ...
      addBase64Image: (base64String:string) => () =>{
        resizeAndUploadBase64Image(base64String, this.editor.view, this.editor.schema);
        return true;
      },
    };
  },
...
const resizeAndUploadBase64Image = async (base64String: string, view: EditorView, schema: Schema) => {
  console.log()
  ...
  startImageUpload(view, file, schema);
  view.focus();
  return true;
}
