...
onBeforeMount(() => {
	emit('setBreadcrumb', [{ name: 'Impressum & Datenschutz', url: '/Impressum' }])
})
...
onBeforeMount(() => {
	if (locale.value != 'de' && !userStore.isLoggedIn) {
		setLocale('de')
	}
})
	...
	<div class="container">
		<div class="row main-page">
			<div class="form-horizontal col-md-12 main-content">
				...
				<p>
					Wir haben diese Datenschutzerkl&auml;rung (Fassung 15.11.2019-311128432) verfasst, um Ihnen
					gem&auml;&szlig;
					der Vorgaben der&nbsp;&nbsp;<NuxtLink :external="true"
						to="https://eur-lex.europa.eu/legal-content/DE/ALL/?tid=1234&amp;uri=celex%3A32016R0679&amp;tid=311128432">
						Datenschutz-Grundverordnung
						(EU) 2016/679</NuxtLink>&nbsp;zu erkl&auml;ren, welche Informationen wir sammeln, wie wir Daten
					verwenden
					und
					welche Entscheidungsm&ouml;glichkeiten Sie als Besucher dieser Webseite haben.
				</p>
				...
				<p>
					...
					eines
					Cookies m&uuml;ssen zus&auml;tzlich ein oder mehrere Attribute angegeben werden.
				</p>

				<p>
					Cookies speichern gewisse Nutzerdaten von Ihnen, wie beispielsweise Sprache oder pers&ouml;nliche
				...
				<p>
					Diese Cookies sorgen f&uuml;r eine bessere Nutzerfreundlichkeit. Beispielsweise werden eingegebene
					Standorte,
					Schriftgr&ouml;&szlig;en oder Formulardaten gespeichert.
				</p>
				...
				<p>
					Wenn Sie feststellen m&ouml;chten, welche Cookies in Ihrem Browser gespeichert wurden, wenn Sie
					Cookie-Einstellungen &auml;ndern oder l&ouml;schen wollen, k&ouml;nnen Sie dies in Ihren
					Browser-Einstellungen
					finden:
				</p>

				<p>
					<NuxtLink :external="true" to="https://support.google.com/chrome/answer/95647?tid=311128432">Chrome:
						Cookies in Chrome
						l&ouml;schen, aktivieren und verwalten</NuxtLink>
				</p>
				...
				<p>
					<NuxtLink :external="true"
						...
						Firefox:
						Cookies l&ouml;schen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben
					</NuxtLink>
				</p>
				...
				<h3>Wie sieht es mit meinem Datenschutz aus?
				...
				<p>
					...
					k&ouml;nnen jedoch nicht ausschlie&szlig;en, dass diese Daten beim Vorliegen von rechtswidrigem
					Verhalten
					eingesehen werden.
				</p>
				...
				<p>
					...
					Einwilligung
					jederzeit widerrufen &ndash; eine formlose E-Mail reicht aus, Sie finden unsere Kontaktdaten im
					Impressum.
				</p>
				...
				<p>
					Unsere Webseite verwendet &quot;Matomo&quot; (ehemals &quot;Piwik&quot;), einen Webanalysedienst der
					InnoCraft Ltd., 150 Willis St, 6011 Wellington, New Zealand. Matomo speichert Cookies auf Ihrem
					Endger&auml;t,
					die eine Analyse der Benutzung unserer Webseite durch Sie erm&ouml;glichen. Die so erhobenen
					Informationen
					werden ausschlie&szlig;lich auf unserem Server gespeichert, und zwar folgende Daten:
				</p>
				...
				<p>
					...
					Nutzererlebnis fortlaufend verbessern zu k&ouml;nnen. Durch die statistische Auswertung des
					Nutzerverhaltens
					verbessern wir unser Angebot und gestalten es f&uuml;r Besucher interessanter.
				</p>
				...
				<p>
					...
					Technikgestaltung&nbsp;&nbsp;<NuxtLink :external="true"
						to="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=311128432">
						Artikel
				...
				<p>
					Google Fonts (fr&uuml;her Google Web Fonts) ist ein interaktives Verzeichnis mit mehr als 800
					Schriftarten,
				...
				<p>
					...
					die die&nbsp;&nbsp;<NuxtLink :external="true"
						to="https://de.wikipedia.org/wiki/Google_LLC?tid=311128432">Google
						LLC</NuxtLink>&nbsp;zur
					freien Verwendung bereitstellt.
				</p>
				...
				<p>
					...
					Vorteil.
					Wenn Sie unsere Seite besuchen, sorgt die niedrige Dateigr&ouml;&szlig;e f&uuml;r eine schnelle
					Ladezeit. Des
				...
				<p>
					...
					wirtschaftliche
					oder ideelle Interessen, die vom Rechtssystem anerkannt werden.
				</p>
				...
				<p>
					...
					Programming
					Interface&ldquo; und dient unter anderem als Daten&uuml;bermittler im Softwarebereich.
				</p>
				...
				<p>
					...
					verwenden.
					Diese Daten werden in der BigQuery-Datenbank von Google Fonts ver&ouml;ffentlicht. BigQuery ist ein
					Webservice
					von Google f&uuml;r Unternehmen, die gro&szlig;e Datenmengen bewegen und analysieren wollen.
				</p>
				...
				<p>
					Jene Daten, die Google f&uuml;r einen Tag bzw. ein Jahr speichert k&ouml;nnen nicht einfach
					gel&ouml;scht
					werden. Die Daten werden beim Seitenaufruf automatisch an Google &uuml;bermittelt. Um diese Daten
					vorzeitig
					l&ouml;schen zu k&ouml;nnen, m&uuml;ssen Sie den Google-Support auf&nbsp;&nbsp;<NuxtLink
						:external="true" to="https://support.google.com/?hl=de&amp;tid=311128432">
						https://support.google.com/?hl=de&amp;tid=311128432</NuxtLink>&nbsp;kontaktieren.
				...
				<p>
					...
					somit auch
					der Datenschutz von Google.
				</p>

				<p>
					Im Folgenden wollen wir Ihnen genauer erkl&auml;ren, welche Daten verarbeitet werden, warum wir
					YouTube-Videos eingebunden haben und wie Sie Ihre Daten verwalten oder l&ouml;schen k&ouml;nnen.
				</p>
				...
				<p>
					Verwendungszweck:&nbsp;Dieses Cookie registriert Ihre eindeutige ID auf mobilen Ger&auml;ten, um den
				...
				<p>
					...
					eingebautem
					YouTube-Video) zu sch&auml;tzen.
				</p>
				<ul>
					<li>
				...
				<p>
					Verwendungszweck:&nbsp;Dieses Cookie wird verwendet, um ein Profil &uuml;ber Ihre Interessen zu
					erstellen.
					Gen&uuml;tzt werden die Daten f&uuml;r personalisierte Werbeanzeigen.
				</p>
				<ul>
				...
				<p>
					...
					&uuml;berpr&uuml;fen und
					Userdaten vor unbefugten Angriffen zu sch&uuml;tzen.
				</p>
				...
				<p>
					Verwendungszweck:&nbsp;Dieses Cookie wird verwendet, um ein Profil &uuml;ber Ihre Interessen zu
					erstellen.
					Diese Daten helfen personalisierte Werbung anzeigen zu k&ouml;nnen.
				</p>
				<ul>
					<li>
				...
				<p>
					Verwendungszweck:&nbsp;Dieses Cookie speichert Informationen, wie Sie die Webseite nutzen und welche
					Werbung
					Sie vor dem Besuch auf unserer Seite m&ouml;glicherweise gesehen haben.
				</p>
				<ul>
					<li>
				...
				<p>
					Die erhobenen Daten speichert Google unterschiedlich lang. Manche Daten k&ouml;nnen Sie jederzeit
					l&ouml;schen, andere werden automatisch nach einer begrenzten Zeit gel&ouml;scht und wieder andere
					werden von
				...
				<p>
					Grunds&auml;tzlich k&ouml;nnen Sie Daten im Google Konto manuell l&ouml;schen. Mit der 2019
					eingef&uuml;hrten
					automatische L&ouml;schfunktion von Standort- und Aktivit&auml;tsdaten werden Informationen
					abh&auml;ngig von
					Ihrer Entscheidung &ndash; entweder 3 oder 18 Monate gespeichert und dann gel&ouml;scht.
				</p>

				<p>
					Unabh&auml;ngig, ob Sie ein Google-Konto haben oder nicht, k&ouml;nnen Sie Ihren Browser so
					konfigurieren,
				...
				<p>
					Anmerkung:&nbsp;Diese Cookies wurden nach einem Test gesetzt und k&ouml;nnen nicht den Anspruch auf
					Vollst&auml;ndigkeit erheben.
				</p>
				...
				<p>
					...
					Bewerbung
					übermittelten Daten in Ihrer Personalakte zum Zwecke des üblichen Organisations- und
				...
				<p>
					...
					gesetzlicher
					Bestimmungen, bspw. wegen der Beweispflichten nach dem AGG, eine längere Speicherung von bis zu vier
					Monaten
					oder bis zum Abschluss eines gerichtlichen Verfahrens erfordern.
				</p>
				<p>
					Rechtsgrundlage ist in diesem Fall Art. 6 Abs. 1 lit. f) DSGVO und § 24 Abs. 1 Nr. 2 BDSG. Unser
					berechtigtes
				...
				<p>
					<NuxtLink target="_blank" :external="true" to="https://www.adsimple.de/datenschutz-generator/">
						Muster-Datenschutzerklärung</NuxtLink>
					der
					<NuxtLink target="_blank" :external="true" to="https://www.adsimple.de/">adsimple.de</NuxtLink>
				</p>
