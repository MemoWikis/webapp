...
class CustomPino {
    ...
    constructor(options: LoggerOptions, seqApiKey: string, seqServerUrl: string) {
...
export default defineNuxtPlugin(() => {
    ...
    return {
        provide: {
            logger: new CustomPino(loggerOptions, config.public.seqApiKey, config.public.seqServerUrl)
        }
    }
})