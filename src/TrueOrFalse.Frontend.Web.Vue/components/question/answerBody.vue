            ...
            <% } %>
                ...
                <% if (Model.IsLearningSession) { %>
                    ...
                    <% } %>
                        ...
                        <input type="hidden" id="disableAddKnowledgeButton"
                            value="<%= Model.DisableAddKnowledgeButton %>" />
                            ...
                            <% if (!Model.IsInWidget) { %>
                                <% if (!Model.DisableAddKnowledgeButton) { %>
                                    <div class="Pin" data-question-id="<%= Model.QuestionId %>">
                                        <%= Html.Partial("AddToWishknowledgeButtonQuestionDetail", new
                                            AddToWishknowledge(Model.IsInWishknowledge, isShortVersion: true)) %>
                                    </div>
                                    <% } %>
                                        <div class="Button dropdown">
                                            <span class="margin-top-4">
                                                ...
                                                <ul
                                                    class="dropdown-menu dropdown-menu-right standard-question-drop-down">
                                                    <% if (Model.IsInLearningTab && (Model.IsCreator ||
                                                        Model.IsInstallationAdmin)){ %>
                                                        <li>
                                                        ...
                                                        <% } %>
                                                            ...
                                                            <% if (Model.IsInLearningTab && Model.IsInstallationAdmin){
                                                                ...
                                                                <% } %>
                                                                    ...
                                                                    <li>
                                                                        <a href="<%=Links.QuestionHistory(Model.QuestionId) %>"
                                                                    ...
                                                                    <li>
                                                                        <a
                                                                            onclick="eventBus.$emit('show-comment-section-modal', <%=Model.QuestionId%>)">
                                                                            <div class="dropdown-icon">
                                                                    ...
                                                                    <% if (Model.IsInLearningTab && (Model.IsCreator ||
                                                                        ...
                                                                        <li>
                                                                            <a href="#"
                                                                                onclick="eventBus.$emit('delete-question',<%=Model.QuestionId %>)">
                                                                                <div class="dropdown-icon">
                        ...
                        <% if (Model.SolutionType !=SolutionType.FlashCard.ToString()) { %>
                            ...
                            <% } %>
                                ...
                                <div class="row">
                                    <% if (Model.SolutionType !=SolutionType.FlashCard.ToString()){ if
                                        (!string.IsNullOrEmpty(Model.QuestionTextMarkdown)){ %>
                                        <div id="MarkdownCol">
                                            <div class="RenderedMarkdown">
                                                <%= Model.QuestionTextMarkdown %>
                                            </div>
                                        </div>
                                        <% } } %>
                                            ...
                                            <div id="AnswerAndSolutionCol">
                                                <div id="AnswerAndSolution">
                                                    ...
                                                    <% if (Model.HasSound) { Html.RenderPartial("AudioPlayer",
                                                        Model.SoundUrl); } %>
                                                        ...
                                                        <div class="row">
                                                            <div id="AnswerInputSection">
                                                                ...
                                                                <input type="hidden" id="hddSolutionTypeNum"
                                                                    value="<%: Model.SolutionTypeInt %>" />
                                                                <% string userControl="SolutionType" +
                                                                    Model.SolutionType + ".ascx" ; if
                                                                    (Model.SolutionMetadata.IsDate)
                                                                    userControl="SolutionTypeDate.ascx" ; if
                                                                    (Model.SolutionType=="MatchList" ) { if
                                                                    ...
                                                                    Html.RenderPartial("~/Views/Questions/Answer/AnswerControls/"
                                                                    + userControl, Model.SolutionModel); if
                                                                    (Model.SolutionType==SolutionType.FlashCard.ToString()){
                                                                    %>
                                                                    <script type="text/javascript">
                                                                        var questionText = '<p class="QuestionText" style="text-align: center; font-family: Open Sans, Arial, sans-serif; margin: 0;"><%= Model.QuestionText %></p>';
                                        ...
                                        $('#flashCardContent').height(
                                            frontHeight > backHeight
                                                ...
                                                : backHeight
                                                                    ...
                                                                    <% } if (Model.SolutionType
                                                                        !=SolutionType.FlashCard.ToString()) { %>
                                                                        <div class="answerFeedback answerFeedbackCorrect"
                                                                            style="display: none;">
                                                                            <i
                                                                                class="fa fa-check-circle">&nbsp;</i>Richtig!
                                                                        </div>
                                                                        <div class="answerFeedback answerFeedbackWrong"
                                                                            style="display: none;">
                                                                            <i
                                                                                class="fa fa-minus-circle">&nbsp;</i>Leider
                                                                            falsch
                                                                        </div>
                                                                        <% } %>
                                                            </div>
                                                                    ...
                                                                    <div id="Buttons">
                                                                        <div id="btnGoToTestSession"
                                                                            ...
                                                                            <% if (Model.HasCategories &&
                                                                                !Model.IsInWidget && !Model.IsForVideo
                                                                                && Model.IsLastQuestion) { %>
                                                                                <a href="<%= Links.CategoryDetailLearningTab(Model.PrimaryCategory) %>"
                                                                        ...
                                                                        <% if
                                                                            (Model.SolutionType==SolutionType.FlashCard.ToString())
                                                                            { %>
                                                                            <a href="#" id="btnFlipCard"
                                                                                class="btn btn-warning memo-button"
                                                                                rel="nofollow">Umdrehen</a>
                                                                            <% } %>
                                                                                ...
                                                                                <% if (Model.SolutionType
                                                                                    ...
                                                                                    <div id="buttons-first-try"
                                                                                        class="ButtonGroup">
                                                                                        <a href="#" id="btnCheck"
                                                                                            class="btn btn-primary memo-button"
                                                                                            rel="nofollow">Antworten</a>
                                                                                        <% if (!Model.IsInTestMode &&
                                                                                            Model.AnswerHelp){ %>
                                                                                            <a href="#"
                                                                                                class="selectorShowSolution SecAction btn btn-link memo-button"><i
                                                                                                    class="fa fa-lightbulb-o">&nbsp;</i>Lösung
                                                                                                anzeigen</a>
                                                                                            <% }%>
                                                                                                <% } else { %>
                                                                                                    <div id="buttons-answer"
                                                                                                        class="ButtonGroup flashCardAnswerButtons"
                                                                                                        style="display: none">
                                                                                                        <a href="#"
                                                                                                            id="btnRightAnswer"
                                                                                                            class="btn btn-warning memo-button"
                                                                                                        ...
                                                                                                        <% if
                                                                                                            ...
                                                                                                            <a href="#"
                                                                                                                ...
                                                                                                                class="selectorShowSolution SecAction btn btn-link memo-button">Nicht
                                                                                                                werten!</a>
                                                                                                            <% } %>
                                                                                                    </div>
                                                                                                    <div>
                                                                                                        <% } %>
                                                                                                            <% if
                                                                                                                ...
                                                                                                                { %>
                                                                                                                <a id="aSkipStep"
                                                                                                                    href="<%= Model.NextUrl(Url) %>"
                                                                                                                    class="SecAction btn btn-link memo-button"><i
                                                                                                                        class="fa fa-step-forward">&nbsp;</i>Frage
                                                                                                                    überspringen</a>
                                                                                                                <% } %>
                                                                                                    </div>

                                                                                                    <div id="buttons-next-question"
                                                                                                        class="ButtonGroup"
                                                                                                        style="display: none;">
                                                                                                        <% if
                                                                                                            (Model.NextUrl
                                                                                                            ...
                                                                                                            !Model.IsLastQuestion)
                                                                                                            { %>
                                                                                                            <a href="<%= Model.NextUrl(Url) %>"
                                                                                                                id="btnNext"
                                                                                                                class="btn btn-primary memo-button"
                                                                                                                rel="nofollow">Nächste
                                                                                                                Frage</a>
                                                                                                            <% }else
                                                                                                                ...
                                                                                                                <button
                                                                                                                    id="continue"
                                                                                                                    class="btn btn-primary clickToContinue memo-button"
                                                                                                                    style="display: none">Weiter</button>
                                                                                                                <% } %>
                                                                                    ...
                                                                                    <div
                                                                                        id="AnswerFeedbackAndSolutionDetails">
                                                                                        <% if (Model.SolutionType
                                                                                            !=SolutionType.FlashCard.ToString())
                                                                                            { %>
                                                                                            <div id="AnswerFeedback">
                                                                                                <div class=""
                                                                                                    id="divAnsweredCorrect"
                                                                                                    style="display: none; margin-top: 5px;">
                                                                                                    <b
                                                                                                        style="color: green;">Richtig!</b>
                                                                                                    <span
                                                                                                        id="wellDoneMsg"></span>
                                                                                                </div>
                                                                                                <div id="Solution"
                                                                                                    ...
                                                                                                    <div class="Label">
                                                                                                        ...
                                                                                                        Antwort:</div>
                                                                                                    <div
                                                                                                        class="Content body-m">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div id="divWrongAnswerPlay"
                                                                                                    class="Detail"
                                                                                                    style="display: none; background-color: white;">
                                                                                                    <span
                                                                                                        style="color: #B13A48"><b>Deine
                                                                                                            Antwort war
                                                                                                            falsch</b></span>
                                                                                                    <div>Deine Eingabe:
                                                                                                    </div>
                                                                                                    <div style="margin-top: 7px;"
                                                                                                        id="divWrongEnteredAnswer">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div id="divWrongAnswer"
                                                                                                    class="Detail"
                                                                                                    style="display: none; background-color: white;">
                                                                                                    <span
                                                                                                        id="spnWrongAnswer"
                                                                                                        style="color: #B13A48"><b>Falsch
                                                                                                            beantwortet
                                                                                                        </b></span>
                                                                                                    <a href="#"
                                                                                                        id="CountWrongAnswers"
                                                                                                        style="float: right;">(zwei
                                                                                                        Versuche)</a><br />

                                                                                                    <div style="margin-top: 5px;"
                                                                                                        id="answerFeedbackTry">
                                                                                                        Du könntest es
                                                                                                        wenigstens
                                                                                                        probieren!</div>

                                                                                                    <div id="divWrongAnswers"
                                                                                                        style="margin-top: 7px; display: none;">
                                                                                                        <span
                                                                                                            class="WrongAnswersHeading">Deine
                                                                                                            bisherigen
                                                                                            ...
                                                                                            <% } %>
                                                                                                ...
                                                                                                <div id="SolutionDetailsSpinner"
                                                                                                    style="display: none;">
                                                                                                    <i class="fa fa-spinner fa-spin"
                                                                                                        style="color: #b13a48;"></i>
                                                                                                </div>

                                                                                                <% if(!string.IsNullOrEmpty(Model.QuestionDescription)
                                                                                                    &&
                                                                                                    Model.QuestionDescription.Trim()
                                                                                                    !="" ){ %>
                                            ...
                                            <div id="ActivityPointsDisplay">
                                                ...
                                                <span id="ActivityPoints">
                                                    <%= Model.TotalActivityPoints %>
                                                </span>
                                                <span style="display: inline-block; white-space: nowrap;"
                                                    class="show-tooltip" data-placement="bottom"
