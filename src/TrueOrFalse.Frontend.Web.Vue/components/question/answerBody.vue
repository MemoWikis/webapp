        ...
        <div class="AnswerQuestionBodyMenu">
            ...
            <% if (!Model.IsInWidget) { %>
                <% if (!Model.DisableAddKnowledgeButton) { %>
                    <div class="Pin" :data-question-id="props.question.Id">
                        <QuestionPin :questionId="props.question.Id" />
                    </div>
                    <% } %>
                    ...
                    <% if (Model.SolutionType !=SolutionType.FlashCard.ToString()){ if
                        ...
                        <% } } %>
                                    ...
                                    <% if (Model.HasSound) { Html.RenderPartial("AudioPlayer", Model.SoundUrl); } %>
                                        ...
                                        <div class="row">
                                            <div id="AnswerInputSection">
                                                ...
                                                <% string userControl="SolutionType" + Model.SolutionType + ".ascx" ; if
                                                    (Model.SolutionMetadata.IsDate) userControl="SolutionTypeDate.ascx"
                                                    ; if (Model.SolutionType=="MatchList" ) { if
                                                    (Request.Browser.IsMobileDevice)
                                                    userControl="SolutionTypeMatchList_LayoutMobile.ascx" ; if
                                                ...
                                                : backHeight
                                                    ...
                                                    <% } if (Model.SolutionType !=SolutionType.FlashCard.ToString()) {
                                                        ...
                                                        <div class="answerFeedback answerFeedbackWrong"
                                                            style="display: none;">
                                                            <i class="fa fa-minus-circle">&nbsp;</i>Leider
                                                            falsch
                                                        </div>
                                                        <% } %>
                                            </div>
                                                ...
                                                <div id="ButtonsAndSolution" class="Clearfix">
                                                    <div id="Buttons">
                                                        <div id="btnGoToTestSession" style="display: none">
                                                            <% if (Model.HasCategories && !Model.IsInWidget &&
                                                                !Model.IsForVideo && Model.IsLastQuestion) { %>
                                                                            ...
                                                                            <% }%>
                                                                                <% } else { %>
                                                                                    <div id="buttons-answer"
                                                                                        ...
                                                                                        style="display: none">
                                                                                        <a href="#" id="btnRightAnswer"
                                                                                            class="btn btn-warning memo-button"
                                                                                            rel="nofollow">Wusste
                                                                                            ich!</a>
                                                                                        <a href="#" id="btnWrongAnswer"
                                                                                            class="btn btn-warning memo-button"
                                                                                            rel="nofollow">Wusste
                                                                                            ich
                                                                                            nicht!</a>
                                                                        ...
                                                                        <% if (Model.SolutionType
                                                                            ...
                                                                            <div id="AnswerFeedback">
                                                                                ...
                                                                                <div id="divWrongAnswer" class="Detail"
                                                                                    style="display: none; background-color: white;">
                                                                                    <span id="spnWrongAnswer"
                                                                                        style="color: #B13A48"><b>Falsch
                                                                                            beantwortet
                                                                                        </b></span>
                                                                                    <a href="#" id="CountWrongAnswers"
                            ...
                            <div id="ActivityPointsDisplay">
                                ...
                                <span style="display: inline-block; white-space: nowrap;" class="show-tooltip"
