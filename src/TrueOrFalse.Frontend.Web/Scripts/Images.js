...
var fnInitImagesItemRow = function () {
    ...
    $('.LicensedImage.ItemRowImage').each(function () {
        $("<div class='SelectAreaLower'>" + "<div data-image-id ='" + $(this).attr('data-image-id') + "' class='HoverMessage JS-ImageDetailModal'>Bild- und Lizenzinfos</div>" + "</div>").insertAfter($(this).parent().find('.SelectAreaUpper'));
    });
    $('.LicensedImage.ItemRowImage').each(function () {
