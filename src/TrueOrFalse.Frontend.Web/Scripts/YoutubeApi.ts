...
// onYouTubeIframeAPIReady() muss ausgelagert werden da Typescript gleiche Funktionsnamen global überprüft ,da es keine Alternative zu onYouTubeIframeAPIReady() gibt ,da dies nach dem Apiload automatisch aufgerufe wird 
