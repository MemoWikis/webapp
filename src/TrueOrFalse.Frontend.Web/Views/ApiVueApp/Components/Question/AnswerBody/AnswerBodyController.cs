...

{
    ...
    {
        return _learningBodyService.MarkQuestionAsCorrect(m.Id, m.QuestionViewGuid,
            m.AmountOfTries);
    }
    ...
    public void CountLastAnswerAsCorrect(
        ...
        _learningBodyService.CountLastAnswerAsCorrect(id, questionViewGuid, interactionNumber,
            testSessionId,
    ...
    public void CountUnansweredAsCorrect(
        ...
        int? testSessionId,
        int? learningSessionId) =>
        _learningBodyService.CountUnansweredAsCorrect(id, questionViewGuid, interactionNumber,
