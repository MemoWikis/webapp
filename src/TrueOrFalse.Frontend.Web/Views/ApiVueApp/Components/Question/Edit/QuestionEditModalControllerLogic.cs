...
namespace VueApp
{
    public class QuestionEditModalControllerLogic : IRegisterAsInstancePerLifetime
    {
        ...
        public RequestResult Create(QuestionDataJson questionDataJson)
        {
            ...
            _learningSessionCreator.InsertNewQuestionToLearningSession(questionCacheItem, questionDataJson.SessionIndex,
                questionDataJson.SessionConfig);
        ...
        private Question UpdateQuestion(Question question, QuestionDataJson questionDataJson, string safeText)
        {
            ...
            {
                var references =
                    ReferenceJson.LoadFromJson(questionDataJson.ReferencesJson, question, _categoryRepository);
