<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<AnalyticsGraphModel>" %>
...
<script>
    var graphJson = $.parseJSON('<%= @Model.GraphDataString %>');
...
<script type="text/javascript">
    ...
    var width = $("#AnalyticsGraph .tab-body").width();
    var height = 600;
