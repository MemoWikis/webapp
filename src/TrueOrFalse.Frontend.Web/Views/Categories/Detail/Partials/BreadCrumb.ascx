    ...
    <div id="StickyHeaderContainer">    
        ...
        <%if(Model.IsLoggedIn){ %>
           <a class="TextLinkWithIcon dropdown-toggle" id="dLabelBreadCrumb" data-toggle="dropdown" href="#">
            ...
            <ul id="BreadcrumbUserDropdown" class="dropdown-menu pull-right" role="menu" aria-labelledby="dLabel" style="right:0px; position: absolute; overflow-y: scroll;  max-height: 515px; ">
                <li>
