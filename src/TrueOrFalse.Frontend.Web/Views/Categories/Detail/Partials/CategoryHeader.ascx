            ...
            <div class="menu-section">
                <div class="menu-container">
                    <div class="menu-item" style="height: 21px;">
                        <a id="mainMenuBtnKnowledge" style="margin-right: 3px;  padding-top:11px; padding-bottom:11px; border-radius:0px;" class="list-group-item menu-section primary-point <%: Model.MenuLeftModel.Active(MenuEntry.Knowledge)%>" href="<%= Links.Knowledge() %>">  
