                ...
                <div class="Button dropdown" v-if="hoverState">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="Dropdown">
                        <li><a href="" data-allowed="logged-in" role="button" 
                               <%-- @click="editContentModule()" --%>
                               data-toggle="modal" data-target="#modalContentModuleSettings" :data-markdown="origMarkdown" :component-id="componentId"><i class="fa fa-copy"></i> Modul konfigurieren</a></li>
