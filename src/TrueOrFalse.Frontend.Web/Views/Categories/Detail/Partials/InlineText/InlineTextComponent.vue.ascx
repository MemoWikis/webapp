<div>
    <textarea-autosize :ref="textAreaId" class="form-control" rows="3" v-model="textContent" :min-height="30" style="padding: 2px; font-size: 18px; margin-left: -3px; margin-top: 20px;" />
