...
<div class="row BoxButtonBar">
    ...
    <div class="BoxButtonColumn">
        <div class="BoxButton show-tooltip"
            data-original-title="Teste dein Wissen mit <%= Settings.TestSessionQuestionCount %> zufällig ausgewählten Fragen aus dieser Kategorie und jeweils nur einem Antwortversuch.">
