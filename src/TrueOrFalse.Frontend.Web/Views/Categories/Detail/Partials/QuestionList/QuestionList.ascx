...
<div id="QuestionListApp">
    ...
    <div>
        <question-list-component inline-template category-id="<%= Model.CategoryId %>" all-question-count="<%= Model.AllQuestionCount %>">
            ...
            <question-component inline-template v-for="q in questions" :question-id="q.Id" :question-title="q.Title" :question-image="q.ImageData" :knowledge-status="q.CorrectnessProbability" :is-in-wishknowldge="q.IsInWishknowledge" :url="q.LinkToQuestion">
                ...
                <div @click="expandQuestion()">
                    ...
                    <div class="questionContainer">
                        ...
                        <div class="extendedQuestion" v-show="showFullQuestion">
                            <div class="questionBody">
                                ...
                                <div class="questionDetails" :data-question-id="questionId"></div>
