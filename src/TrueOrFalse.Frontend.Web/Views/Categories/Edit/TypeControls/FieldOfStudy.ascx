...
<h4 class="CategoryTypeHeader"><%= CategoryType.FieldOfStudy.GetName() %></h4>
...
<div class="form-group" style="padding-top: 20px; padding-bottom: 20px;">
    <label class="columnLabel control-label" for="Url">
        Offizielle Webseite des Studienfaches
        <i class="fa fa-question-circle show-tooltip" 
    ...
    <label class="columnLabel control-label" for="UrlLinkText">
        ...
        <i class="fa fa-question-circle show-tooltip" 
           title="Gib hier einen Text an, der den Link beschreibt, zum Beispiel 'Offizielle Webseite des Studienfaches'. Lässt du das Feld leer, wird die Link-Adresse angezeigt." data-placement="<%= CssJs.TooltipPlacementLabel %>">
        </i>
    </label>
    <div class="columnControlsFull">
