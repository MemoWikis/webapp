...
var DateRowDelete = (function () {
    function DateRowDelete() {
        var self = this;
        var dateIdToDelete;
    ...
    DateRowDelete.prototype.PopulatModal = function (dateId) {
        $.ajax({
            type: 'POST',
    ...
    DateRowDelete.prototype.DeleteDate = function (dateId) {
        $.ajax({
            type: 'POST',
    ...
    return DateRowDelete;
})();
//# sourceMappingURL=DateRowDelete.js.map
