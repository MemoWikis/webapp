    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li class="<%= Model.CurrentIsHelp ? "active" : "" %> dropdown">
                <a href="/Hilfe/Widget" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Einbetten <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="<%= "/Hilfe/Widget" %>">Überblick</a></li>
