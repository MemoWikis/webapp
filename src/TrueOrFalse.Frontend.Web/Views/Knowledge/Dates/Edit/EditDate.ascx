...
<div id="vueSafeDates">
    ...
    <div class="row">
        <div class="col-md-9 xxs-stack">
            <user-message v-bind:text="userMessage"></user-message>
        </div>
                ...
                <div class="FormSection">
                    ...
                    <div class="form-group">
                        ...
                        <div class="columnControlsFull">
                            <%= Html.TextBoxFor(m => m.Details, new {@class="form-control", placeholder = "(z.B. Test Geografie)", v_model="name"}) %>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-11">
                                    <div class="input-group date">
                                        <input class="form-control" name="Date" id="Date" v-model="date" value="<%= Model.Date.ToString("dd.MM.yyyy") %>" style="height: 30px;" />
                    ...
                    <div>
                        <div class="noLabel columnControlsFull">
                            <button href="#" id="btnSave" class="btn btn-primary" v-on:click="save">
