         ...
         <div class="Button dropdown">
            ...
            <% if (true)
                { %>
                    ...
                    <li style="margin-top: 2rem;"><a v-bind:href="props.rowData.DateToLearningTopicLink" rel="nofollow" data-allowed="logged-in"><i class="fa fa-calendar"></i>&nbsp;Lernset bearbeiten</a></li>
