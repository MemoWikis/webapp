        ...
        <div class="col-sm-9 xxs-stack">
            ...
            <div id="comments">
                ...
                <% if (Model.CommentsSettledCount > 0) { %>
                    <div class="commentSettledInfo" style="">
                        Diese Frage hat <%= Model.CommentsSettledCount %> 
                        <% if (Model.Comments.Any()) Response.Write("weitere "); %>
                        als erledigt markierte<%= StringUtils.PluralSuffix(Model.CommentsSettledCount,"","n") %> Kommentar<%= StringUtils.PluralSuffix(Model.CommentsSettledCount,"e") %> (<a href="#" id="showAllCommentsInclSettled" data-question-id="<%= Model.QuestionId %>">alle anzeigen</a>).
                    </div>
                <% } %>
            </div>
