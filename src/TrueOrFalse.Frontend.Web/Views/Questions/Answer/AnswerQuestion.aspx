...
<asp:Content ID="head" ContentPlaceHolderID="Head" runat="server">
    ...
    <style type="text/css">
        ...
        .valRow .valColumn2 .imgDelete {
            position: relative;
            left: 10px;
            top: -3px;
        }

        .valRow .valColumn2 .valMine {
            margin-top: -2px;
            padding-top: 0;
            padding-left: 5px;
            float: left;
    ...
    <div class="" style="width: 100%; padding: 0 20px;">
        ...
        <div class="row">
            ...
            <div class="row" style="margin-top: 30px; color: darkgray; font-weight: bold;">
                    ...
                    <div class="col-xs-8 " style="vertical-align: text-bottom; vertical-align: bottom; margin-top: 3px; text-align: right">
                        <% if (Model.IsLoggedIn)
                            { %>
                        <span style="padding-right: 2px">Die Frage bitte: &nbsp;
