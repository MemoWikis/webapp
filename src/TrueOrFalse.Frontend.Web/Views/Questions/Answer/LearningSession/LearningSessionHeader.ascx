...
<div id="SessionHeaderContainer">
    ...
    <div class="SessionBar">
        <div class="QuestionCount">Frage <span id="CurrentStepNumber"><%= Model.CurrentLearningStepIdx + 1 %></span>von<span id="StepCount">1</span></div>
