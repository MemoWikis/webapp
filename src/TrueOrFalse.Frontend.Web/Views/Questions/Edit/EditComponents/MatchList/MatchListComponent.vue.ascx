        ...
        <div class="matchlist-options">
            ...
            <div class="matchlist-right">
                <div v-for="(element, i) in rightElements" :key="i" class="form-group">
                        <div class="d-flex">
                            <input type="text" class="form-control col-sm-10" :id="i" v-model="element.Text" placeholder="" v-on:change="solutionBuilder()" :class="{ 'is-empty': element.Text.length <= 0 && highlightEmptyFields }">
