...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm()) { %>
        <ul class="nav nav-tabs" style="margin-bottom: 0px; border: none;">
            <li class="active"><a href="#home" style="border: none; padding-bottom: 12px; margin-bottom: -4px;">Alle Fragen (<%= Model.TotalQuestionsInSystem %>)</a></li>
            <li>
                <a href="#profile">
