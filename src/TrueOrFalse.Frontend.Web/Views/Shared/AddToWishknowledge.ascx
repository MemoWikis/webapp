...
<span class="iAddedNot <%= Model.IsWishknowledge ? "hide2" : "" %>"><i class="fa fa-heart-o show-tooltip" style="color:#b13a48;" title="Zu deinem Wunschwissen hinzuzufügen"></i></span>
