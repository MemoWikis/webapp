            ...
            <div class="modal-body" id="modalBody">
                ...
                <div id="divWikimedia">
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <div class="hide2" style="padding-left:101px; margin-top: 5px;" id="divWikimediaSpinner">
                            <i class="fa fa-spinner fa-spin fa-2x pull-left"></i><span style="position: relative; top: 1px;">Vorschau wird geladen</span>
                        </div>
                        <div class="hide2" style="padding-left:101px; margin-top: 5px;" id="divWikimediaError">
                            <i class="fa fa-warning" style="color:orange"></i> Das Bild konnte nicht geladen werden.
                        </div>
                
                        <div id="previewWikimediaImage" class="hide2" style="padding-left:101px; margin-top:8px;"></div>
                    </div>            
                </div>
                ...
                <div id="divUpload" class="hide2">
                    ...
                    <div id="previewImage" class="hide2" style="margin-top:8px;"></div>
