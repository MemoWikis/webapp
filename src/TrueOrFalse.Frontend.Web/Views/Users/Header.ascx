    ...
    <ul class="nav nav-tabs">
        ...
        <li class="<%= Html.IfTrue(Model.IsNetworkTab, "active") %>">
            <a href="<%= Url.Action("Network", "Users") %>">
                ...
                <i class="fa fa-question-circle show-tooltip" id="tabInfoMyKnowledge" data-placement="right" title="Hier siehst du, wer dir folgt und wem du folgst. Hier kannst du Nutzer zu deinem Netzwerk hinzufügen"></i>
            </a>
        </li>
    </ul>
</div>