...
<asp:Content ID="ContentHeadSEO" ContentPlaceHolderID="HeadSEO" runat="server">
    ...
    <% 
        Model.TopNavMenu.BreadCrumb.Add(new TopNavMenuItem {Text = "Mein Netzwerk", Url = Links.Network(), ToolTipText = "Mein Netzwerk"});
        ...
        <div class="boxtainer-outlined-tabs">
            ...
            <% if(!Model.IsLoggedIn){ %>
                <div class="bs-callout bs-callout-danger">
                    ...
                    <p>Um dein Netzwerk zu sehen, musst du dich <a href="#" data-btn-login="true" onclick="eventBus.$emit('show-login-modal')">einloggen</a> 
