            ...
            <div class="form-group omb_login row">
                <div class="col-sm-offset-2 col-sm-8 omb_socialButtons" style="padding-right: 5px;">
                    <div class="col-xs-12 col-sm-6 socialMediaBtnContainer">
                        <a class="btn btn-block cursor-hand" id="FacebookRegister" onclick="eventBus.$emit('login-Facebook')">
                    ...
                    <div class="col-xs-12 col-sm-6 socialMediaBtnContainer" style="padding-left: 5px;">
                        <a class="btn btn-block cursor-hand" id="GoogleRegister">
                            <img src="/Images/SocialMediaIcons/Google__G__Logo.svg" alt="GoogleRegister" class="socialMediaLogo"><span style="text-transform: uppercase;">weiter mit Google</span>
                        </a>
                    </div>
                </div>
            </div>
