        ...
        <div class="form-horizontal col-md-12">
            ...
            <div class="form-group omb_login">
                <div class="row omb_socialButtons">
                    <div class="col-xs-12 col-sm-4 col-sm-offset-2 socialMediaBtnContainer">
                    ...
                    <div class="col-xs-12 col-sm-4 socialMediaBtnContainer">
...
<%--                    <%: Html.LabelFor(model => model.Name, new { @class = "col-sm-2 col-sm-offset-2 control-label" }) %>--%>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-8" style="border-top: 0px; margin-top: 10px; padding: 0;">
