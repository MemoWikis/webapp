...
<div class="CardColumn">
    <div class="thumbnail">
        ...
        <div class="caption">
            <h6 style="margin-bottom: 5px; color: #a3a3a3;">Thema mit <a href="<%: Links.QuestionWithCategoryFilter(Url, Model.ContextCategoryName, Model.ContextCategoryId) %>"><%= Model.QCount %> Fragen</a></h6>
