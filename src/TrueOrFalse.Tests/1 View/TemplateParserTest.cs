...
class TemplateParserTest
{
    ...
    //{
    //    var content = "[{\"TemplateName\":\"TopicNavigation\",\"Title\":\"Unterthemen\"}]";
    //    MarkdownSingleTemplateToHtml.Run("Test", new Category("test"), new ControllerContext());
    //}    
    
    //[Test]
    //public void Parser_should_parse_inline_text_correct()
    //{
    //    var content = "[{\"TemplateName\":\"InlineText\",\"Content\":\" <p> Lorem Ipsum </p>\n<p> <a href=\"https://google.com\">https://de.wikipedia.org/wiki/Elektrotechnik</a></p>\n\"}]";
    //    MarkdownSingleTemplateToHtml.Run("Test", new Category("test"), new ControllerContext());
    //}
