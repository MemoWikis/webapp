...
namespace TrueOrFalse.Tests
{
    public class UserNavigationModelListTest
    {
        ...
        public void Should_not_allow_more_than_3_elements()
        {
            ...
            for (var i = 0; i < 5; i++ )
                list.Add(new UserHistoryItem(new UserCacheItem { Id = i, Name = "John Doe"}));
        ...
        {
            var list = new UserHistory();
            list.Add(new UserHistoryItem(new UserCacheItem { Id = 1, Name = "John Doe" }));
            list.Add(new UserHistoryItem(new UserCacheItem { Id = 1, Name = "John Doe" }));

            Assert.That(list.Count(), Is.EqualTo(1));

            var list2 = new UserHistory();
            list2.Add(new UserHistoryItem(new UserCacheItem { Id = 1, Name = "John Doe 1" }));
            list2.Add(new UserHistoryItem(new UserCacheItem { Id = 2, Name = "John Doe 2" }));
