...
namespace TrueOrFalse.Tests
{
    public class ImageMetadata_from_wikimedia : BaseTest
    {
        ...
        {
            var result1 = Resolve<WikimediaImageMetaLoader>().Run("Platichthys_flesus_Vääna-Jõesuu_in_Estonia.jpg");
            ...
            var result2 = Resolve<WikimediaImageMetaLoader>().Run("http://commons.wikimedia.org/wiki/File:Berlin_relief_location_map-names.png");
        ...
        {
            Assert.That(
                Resolve<WikimediaImageMetaLoader>().Run("not-existing-image-9812.jpg").ImageNotFound,
                Is.True
            );
        }
    }
