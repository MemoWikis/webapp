...
namespace TrueOrFalse.Tests
{
    public class Set_manipulate : BaseTest
    {
        ...
        [Test]
        public void Should_update_aggregated_categories2()
        {
            ContextCategory.New().Add("1").Add("2").Add("3").Persist();

            var category1 = Sl.R<CategoryRepository>().GetByName("1").FirstOrDefault();//Reload to ensure that direct db update of CountSet is considered
            ...
            category1 = Sl.R<CategoryRepository>().GetByName("1").FirstOrDefault();//Reload to ensure that direct db update of CountSet is considered
