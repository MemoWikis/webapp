...
namespace TrueOrFalse
{
    ...
    {
        public WikiImageMeta Run(string fileNameOrUrl, int thumbUrlWidth = 1024, string host = "http://commons.wikimedia.org")
        {
            ...
            {
                if (host != "http://commons.wikimedia.org")
                {
                    //if(host)
                    //new Uri(file)
                }
