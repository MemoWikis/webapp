...
public class QuestionValuationRepo : RepositoryDb<QuestionValuation>
{
    ...
    public override void Create(IList<QuestionValuation> questionValuations)
    {
        ...
        {
            SessionUserCache.AddOrUpdate(questionValuation.ToCacheItem(), _categoryValuationReadingRepo, _userReadingRepo, _questionValuationRepo);
        }
    }
    ...
    {
        return SessionUserCache.GetAllCacheItems(_categoryValuationReadingRepo, _userReadingRepo, _questionValuationRepo)
    ...
    {
        return SessionUserCache.GetItem(userId, _categoryValuationReadingRepo, _userReadingRepo, _questionValuationRepo)?.QuestionValuations
    ...
    {
        var questionValuations = SessionUserCache.GetAllCacheItems(_categoryValuationReadingRepo, _userReadingRepo, _questionValuationRepo).Select(c => c.QuestionValuations.Values)
            .SelectMany(l => l);
    ...
    {
        var cacheItem = SessionUserCache.GetItem(userId, _categoryValuationReadingRepo, _userReadingRepo, _questionValuationRepo);
