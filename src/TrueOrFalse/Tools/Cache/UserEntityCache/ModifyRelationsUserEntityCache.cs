        ...
        public static void UpdateRelationsIncludetContentOf(CategoryCacheItem child)
        {
          ...
          foreach (var cache in allCaches)
          {
              if (cache.ContainsKey(child.Id))
              {
                  ...
                  // nimmst das child und durchläufst den Cache nach der SUche der Parents alle Parents bekommen eine neue Relation
                  // die als RelatetId das Child enthält,das muss innerhalb des Ifs passieren damit ich keinen Cache ändere der das Child gar nicht enthält.  
              }
