    ...
    public class Update : IRegisterAsInstancePerLifetime
    {
        ...
        public void Run()
        {
            _updateStepExecuter
                ...
                .Add(67, UpdateToVs067.Run)
                .Add(68, UpdateToVs068.Run)
                .Add(69, UpdateToVs069.Run)
                .Add(70, UpdateToVs070.Run)
                .Add(71, UpdateToVs071.Run)
                .Add(72, UpdateToVs072.Run)
                .Add(73, UpdateToVs073.Run)
                .Add(74, UpdateToVs074.Run)
                .Add(75, UpdateToVs075.Run)
                .Add(76, UpdateToVs076.Run)
                .Add(77, UpdateToVs077.Run)
                .Add(78, UpdateToVs078.Run)
                .Add(79, UpdateToVs079.Run)
